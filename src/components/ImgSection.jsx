  ...
  return (
    <section className="py-12">
      <div className="flex flex-col sm:flex-row lg:mb-0">
        ...
        <div className="w-full basis-2/4 p-4 xl:px-12 lg:p-6  bg-gray-100 ">
          <h2 className="text-2xl mb-4 px-2 md:px-8 font-bold mt-2 xl:p-2 ">
            Descubre cómo un Trader Profesional Puede Potenciar tus Inversiones
          </h2>
          <p className="px-2 md:px-8 xl:p-2">
      ...
      <div className="flex flex-col sm:flex-row">
        <div
          className="w-full basis-2/4 p-4 xl:px-12 lg:p-6 order-2 md:order-1 bg-gray-100 "
          id="contacto"
        >
          <h2 className="text-2xl mb-4 px-2 md:px-8 font-bold mt-2 xl:p-2">
            Servicio 24 Horas
          </h2>
          <p className="xl:p-2 px-2 md:px-8">
